<div align="center" id="Accountabel AI">

<a href="https://github.com/yincongcyincong/MuseBot" title="TrendRadar">
  <img src="/static/logo.png" alt="Accountabel AI Banner" width="50%">
</a>

🚀 Connect your communication app to AI in just one minute

[![GitHub Stars](https://img.shields.io/github/stars/yincongcyincong/Accountabel AI?style=flat-square&logo=github&color=yellow)](https://github.com/yincongcyincong/MuseBot/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/yincongcyincong/Accountabel AI?style=flat-square&logo=github&color=blue)](https://github.com/yincongcyincong/MuseBot/network/members)
...
[![Docker](https://img.shields.io/badge/Docker-deploy-2496ED?style=flat-square&logo=docker&logoColor=white)](https://hub.docker.com/search?q=accountabel)
...
- 🌞 **AdminPlatform**: Use platform to manage Accountabel AI,
...
Use docker
   ...
   ```sh
     docker pull jackyin0822/accountabel:latest
     chmod 777 /home/user/data
     docker run -d -v /home/user/data:/app/data -e TELEGRAM_BOT_TOKEN="telegram-bot-token" -e DEEPSEEK_TOKEN="deepseek-auth-token" -p 36060:36060 --name my-bot  jackyin0822/Accountabel AI:latest
   ```

   ```sh
    ALIYUN:
    docker pull crpi-i1dsvpjijxpgjgbv.cn-hangzhou.personal.cr.aliyuncs.com/jackyin0822/accountabel:latest
    chmod 777 /home/user/data
     docker run -d -v /home/user/data:/app/data -e TELEGRAM_BOT_TOKEN="telegram-bot-token" -e DEEPSEEK_TOKEN="deepseek-auth-token" -p 36060:36060 --name my-bot  crpi-i1dsvpjijxpgjgbv.cn-hangzhou.personal.cr.aliyuncs.com/jackyin0822/accountabel:latest
   ```
...
If you use parameter. Please use lower letter and underscore. for example: ./Accountabel AI -telegram_bot_token=xxx
...
| **QQ_ONEBOT_RECEIVE_TOKEN**     | Token for ONEBOT → Accountabel AI event messages                                                    | Accountabel AI                                                |
| **QQ_ONEBOT_SEND_TOKEN**        | Token for Accountabel AI → ONEBOT message sending                                                   | Accountabel AI                                                |
...
| **DB_CONF**                     | Database config path or connection string                                                    | ./data/accountabel_bot.db                                     |
...
| **HTTP_HOST**                   | Accountabel AI HTTP server port                                                                     | :36060                                                 |
...
| **BOT_NAME**                    | Bot name                                                                                     | Accountabel AI                                                |
...
2. **Run the container**
   ```sh
     docker run -d -v /home/user/xxx/data:/app/data -e TELEGRAM_BOT_TOKEN="telegram-bot-token" -e DEEPSEEK_TOKEN="deepseek-auth-token" --name my-bot Accountabel AI
   ```
