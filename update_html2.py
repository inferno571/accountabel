...
<head>
    ...
    <title>Accountabel AI - Reclaim Your Life</title>
...
<body>
    ...
    <main>
        <section class="hero">
            <div class="hero-text">
                <h1>Break free.<br>Reclaim your life.</h1>
                <p>Break free from bad habits. Let our anti-addiction AI chatbot keep you accountable and focused on your personal goals.</p>
                <div class="cta-group">
                    <button class="btn btn-primary" onclick="document.getElementById('onboarding').scrollIntoView({behavior: 'smooth'})">Get Started Now</button>
        ...
        <section class="section-light">
            <h2>THE ADDICTION CYCLE</h2>
            <p>It's hard to break bad habits alone. Accountability helps you recognize triggers, manage cravings, and build healthier routines.</p>
            
            <div class="cards">
                <div class="card">
                    <h3>Understand Your Triggers</h3>
                    <p>Recognize the emotional and environmental cues that lead to relapse. Our AI helps you log and reflect on what sets you back, building self-awareness.</p>
                </div>
                <div class="card">
                    <h3>Consistent Accountability</h3>
                    <p>Willpower alone often isn't enough. Daily check-ins build a strong foundation of accountability that makes you reconsider before giving in to cravings.</p>
                </div>
                <div class="card">
                    <h3>Judgment-Free Support</h3>
                    <p>Relapse is a part of recovery. Chat securely with an AI that provides immediate, judgment-free support whenever you feel vulnerable or overwhelmed.</p>
                </div>
            </div>
        </section>
        ...
        <section class="features-section">
            ...
            <div class="checkmarks">
                ...
                <div class="check-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    Set Custom Habit Goals
                </div>
                <div class="check-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    Craving Tracking & Analysis
                </div>
                <div class="check-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    Private & Secure Chat
            ...
            <button class="btn btn-primary" onclick="document.getElementById('onboarding').scrollIntoView({behavior: 'smooth'})">Get Started For Free</button>
        </section>

        <section id="onboarding" class="onboarding-section">
            <h2>JOIN OTHERS WINNING THEIR LIVES BACK</h2>
            <p>Start your journey toward a healthier, more balanced life today.</p>
